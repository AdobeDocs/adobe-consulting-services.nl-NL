...
Bedankt dat u hebt gekozen om bij te dragen aan de documentatie van Adobe Consulting Services. Wij zijn blij met de bijdragen van onze gehele lezergemeenschap en van collega-Adoben.
...
Dit project heeft het [Adobe Open Source Code of Conduct](code-of-conduct.md). Door bij te dragen aan AEM documentatie gaat u akkoord met het naleven van deze gedragscode. Geef een onacceptabel gedrag aan [Grp-opensourceoffice@adobe.com](mailto:Grp-opensourceoffice@adobe.com).

## Richtsnoeren voor de bijdrage

Wij zijn blij met alle bijdragen aan de verbetering van AEM documentatie, maar wij vragen wel dat de bijdragen waar mogelijk aan bepaalde richtsnoeren en normen voldoen. Controleer de [Richtsnoeren voor de bijdrage aan de ACS-documentatie](guidelines.md) voor meer informatie .
...
Als u een Adobe werknemer bent en een bijdrage hebt, gelieve te gebruiken `AdobeDocs` org in het bedrijfsgat.
